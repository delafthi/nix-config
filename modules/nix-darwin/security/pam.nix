      ...
      u2f = {
        enable = lib.mkOption {
          ...
          description = ''
            ...
            File format is:
            ```
            <username1>:<KeyHandle1>,<UserKey1>,<CaseType1>,<Options1>:<KeyHandle2>,<UserKey2>,<CaseType2>,<Options2>:...
            <username2>:<KeyHandle1>,<UserKey1>,<CaseType1>,<Options1>:<KeyHandle2>,<UserKey2>,<CaseType2>,<Options2>:...
            ```
